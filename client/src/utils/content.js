...
const content ={
    ...
    hero: {
        firstName: "Nirnaya ",
        LastName: "Revolutionizing agriculture with cutting-edge AI solutions",
        btnArray: ["A Programmer","AI & ML Enthusiast"],
        image: Home,
      },
    about:{
        content: "Myself I am Satyam. A diligent final Computer Science student at VIT Vellore with an immense passion for AI&ML and MERN. Currently I am Advanced Application Analyst Engineer at Accenture. A passionate programmer, highly motivated and quick learner. I am always curious about things and enjoy learning. I like to solve problems and fix errors. I am a detailed oriented person and I keep my goals and tasks organized."
      },
    aboutus:{
        content1: "Nirnaya is an innovative project aimed at revolutionizing the way farmers choose crops and make decisions about their farming operations. With the use of cutting-edge technology and machine learning algorithms, Nirnaya provides farmers with a comprehensive and accurate picture of their farm's potential. This includes soil analysis, location-based data, and rainfall information, which can be used to determine the most suitable crops for a given area.",

        content2: "Nirnaya not only provides recommendations on the best crops to plant but also provides farmers with an estimated crop price forecast. This helps farmers make informed decisions about their crop choices, ensuring that they can maximize their profits. Additionally, the crop analytics offered by Nirnaya helps farmers track the progress of their crops over time and make adjustments as necessary.",
        
        content3: "The algorithms used by Nirnaya are constantly learning and improving, taking into account real-time data and the latest research to provide farmers with the most up-to-date information. This helps to ensure that farmers have access to the most accurate information, reducing the risk of crop failure and increasing the chances of success.",
        
        content4: "Nirnaya also offers a user-friendly interface that makes it easy for farmers to access and understand the information they need. Whether you are a seasoned farmer or just starting out, Nirnaya has the tools and resources you need to make informed decisions about your crops and farming operations."
    },
    Contact: {
        title: "Contact Me",
        subtitle: "Spot a Bug? Fix it with Us!",
        social_media: [
          {
            text: "ssoni6149@gmail.com",
            icon: GrMail,
            link: "mailto:ssoni6149@gmail.com",
          },
          {
            text: "the_satyamsoni",
            icon: BsInstagram,
            link: "https://www.instagram.com/the_satyamsoni/",
          },
          {
            text: "thesatyamsoni",
            icon: GrLinkedin,
            link: "https://www.linkedin.com/in/thesatyamsoni/"
          },
          {
            text:"satyamsoni228",
            icon: BsGithub,
            link: "https://github.com/satyamsoni228",
          },
          {
            text: "Satyam Soni",
            icon: BsFacebook,
            link: "https://www.facebook.com/satyam.soni.1238292",
          }
        ],
    },
    predictions: {
